...
The `nngeo::raster_extract()` function comes in handy to apply `raster::extract()` on `stars` objects. It’s used here inside `mutate` to add new variables with the extracted values for each species (it's vectorized for each feature 😎).
...
{% endhighlight %}
 ...
 <figure>
    <a href="/images/mesoamFcts.png"><img src="/images/mesoamFcts.png"></a>
