...
First is something that I always see in my field of comparative biology, header rows interspersed within a list of species to show different hierarchical taxonomic levels (families end in _dae_). This was actually what made me look into this.
