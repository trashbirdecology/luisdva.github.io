...
layout: post
excerpt: Data cleaning, Principal Components Analysis, and visualization of AoE2 data.
category: rstats
tags:
  - PCA
  - factominer
...
[site](https://aoe2stats.net/){:target="_blank"}
 with stats for each unit. It’s a great reference, but I wanted to explore the data further. This post describes the various steps for reading and cleaning the data, followed by some visualization of the main outputs from a dimension reduction via Principal Components Analysis (PCA).
...
- Extracting values from compound variables through regular expressions
...
<figure>
    <a href="/images/aocstats.png"><img src="/images/aocstats.png" width= "400"></a>
...
<figure>
    <a href="/images/contrs.png"><img src="/images/contrs.png" width= "400"></a>
        <figcaption></figcaption>
</figure>
<figure>
    <a href="/images/corrs.png"><img src="/images/corrs.png" width= "400"></a>
        <figcaption></figcaption>
</figure>
...
<figure>
    <a href="/images/units.png"><img src="/images/units.png" width= "650"></a>
        <figcaption></figcaption>
</figure>
...
<figure>
    <a href="/images/globpca.png"><img src="/images/globpca.png" width= "650"></a>
        <figcaption></figcaption>
</figure>
